...
Before opening a fresh issue, do a search on [the wiki](http://robots.uc3m.es/index.php/ASIBOT) and on [GitHub](https://github.com/roboticslab-uc3m/asibot-openrave-models/issues?utf8=%E2%9C%93&q=is%3Aissue) and make sure it hasn't already been addressed. Here are some notes on how to detail feature requests or bug reports:
